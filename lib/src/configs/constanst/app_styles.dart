...
class AppStyles {
  ...
  static const DEFAULT_SMALL = TextStyle(
      fontSize: FONT_SIZE_SMALL, height: TEXT_HEIGHT, fontFamily: FIRA);
  static const DEFAULT_MEDIUM = TextStyle(
      fontSize: FONT_SIZE_MEDIUM, height: TEXT_HEIGHT, fontFamily: FIRA);
  static const DEFAULT_LARGE = TextStyle(
      fontSize: FONT_SIZE_LARGE, height: TEXT_HEIGHT, fontFamily: FIRA);
